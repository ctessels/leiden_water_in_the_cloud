from custom_functions.visuals import sensor_visual  # Re-import the function
...
import os
import importlib
import custom_functions.visuals  # Import the module
importlib.reload(custom_functions.visuals)  # Reload the module
